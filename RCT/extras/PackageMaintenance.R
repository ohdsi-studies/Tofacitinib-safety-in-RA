...
OhdsiRTools::checkUsagePackage("BridgetTofaRCT1108")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/BridgetTofaRCT1108.pdf")
shell("R CMD Rd2pdf ./ --output=extras/BridgetTofaRCT1108.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "BridgetTofaRCT1108")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("BridgetTofaRCT1108")
