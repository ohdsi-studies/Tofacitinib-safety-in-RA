...
2. In `R`, use the following `devtools` command to install the BridgetTofaRCT1108 package:
...
3. Once installed, you can execute the study by modifying and using the code below. For your convenience, this code is also provided under `extras/CodeToRun.R`:
	...
	outputFolder <- "c:/BridgetTofaRCT1108"
...
License
=======
The BridgetTofaRCT1108 package is licensed under Apache License 2.0

Development
===========
BridgetTofaRCT1108 was developed in ATLAS and R Studio.
