...
OhdsiRTools::checkUsagePackage("BridgetTofa1108")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/BridgetTofa1108.pdf")
shell("R CMD Rd2pdf ./ --output=extras/BridgetTofa1108.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("BridgetTofa1108")
